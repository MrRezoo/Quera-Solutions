...
class TestContest(TestCase):
    ...
    def test_list_problem(self):
        ...
        self.assertQuerysetEqual(
            qs,
            [
                "<Problem: Problem object (1)>",
                "<Problem: Problem object (2)>",
    ...
    def test_sample_list_users(self):
        qs = list_users(1)
        self.assertQuerysetEqual(
            qs, ["<User: SAliB>", "<User: Saeid>", "<User: Ali>"], ordered=False
        )
    ...
    def test_sample_list_submissions(self):
        ...
        self.assertQuerysetEqual(
            qs,
            [
                "<Submission: Submission object (12)>",
                "<Submission: Submission object (6)>",
                "<Submission: Submission object (16)>",
                "<Submission: Submission object (5)>",
                "<Submission: Submission object (11)>",
                "<Submission: Submission object (15)>",
                "<Submission: Submission object (14)>",
                "<Submission: Submission object (4)>",
                "<Submission: Submission object (10)>",
                "<Submission: Submission object (9)>",
                "<Submission: Submission object (3)>",
                "<Submission: Submission object (8)>",
                "<Submission: Submission object (2)>",
                "<Submission: Submission object (13)>",
                "<Submission: Submission object (1)>",
                "<Submission: Submission object (7)>",
            ],
        )
